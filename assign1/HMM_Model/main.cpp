...
int main()
{
    ...
    // model.printOutObsSeq();

    model.train();
    array2d<double> updateTran;
    array2d<double> updateEmis;
    array2d<double> updatePi;

    model.getModelParams(updateTran, updateEmis, updatePi);
    printAns(updateTran, updateEmis);
}